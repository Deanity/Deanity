...
<h1>Hi, I'm Dendra 👋 — aka <code>De4nity</code></h1>

<h3>🌐 Full Stack Developer &nbsp;|&nbsp; 📱 Mobile Apps Developer &nbsp;|&nbsp; 🎨 UI/UX Designer</h3>

<img src="https://user-images.githubusercontent.com/22107794/139580686-887df369-edb8-4bc8-b607-4fbf6d7e4866.gif" width="480"/>

<br/>

![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&pause=1000&color=00F7FF&center=true&vCenter=true&width=500&lines=Frontend+%7C+Backend+%7C+Mobile+Dev;Building+beautiful+%26+functional+apps;Turning+ideas+into+digital+experiences+✨)
...
Hey there! I'm **Dendra De Tama** (`De4nity`), a passionate developer and designer from Bali 🌴

- 🎓 Graduate of **SMK** majoring in **Rekayasa Perangkat Lunak (Software Engineering)**
- 🔥 I love crafting **full-stack web apps**, **mobile apps**, and **sleek UI/UX designs**
- 🚀 Always exploring new technologies and pushing creative boundaries
- 🎯 Focused on building **innovative**, **user-centered** digital solutions
- ⚡ Fun fact: I go by **De4nity** online — clean, sharp, unforgettable
...
<div align="center">
  ...
  <img width="12" />
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/apple/apple-original.svg" height="40" alt="iOS" title="iOS"/>
</div>
